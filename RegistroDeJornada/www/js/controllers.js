...
.controller('AppCtrl', function($scope, $ionicModal, $timeout, $http, $ionicPopup) {
  ...
  $scope.doLogin = function() {
   ...
   $scope.showAlertDescanso = function(status) {
...
function teste(status, botao){
  var valor ={
    pCod_RegistroJornada: 3,
    pNum_SeqlMotorista: 1,
    pInd_Localizacao: '12345'
  }
    $.post("http://192.168.26.247:15002/motorista/jornada",{
      pCod_RegistroJornada: 3,
    pNum_SeqlMotorista: 1,
    pInd_Localizacao: '12345'
    }).done(function(data){
